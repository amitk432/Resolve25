...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-start rounded-none border-b-0 bg-transparent p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:bg-gradient-primary after:scale-x-0 after:transition-transform after:duration-300 data-[state=active]:after:scale-x-100",
      className
    )}
    {...props}
  />
