          ...
          {/* Contact info in one line */}
            ...
            {resumeData?.contactInfo?.phone && (
              <span key="phone" style={{ 
                ...
                <svg width="12" height="12" fill="#0056b3" style={{ flexShrink: 0, display: 'block' }} viewBox="0 0 24 24"><path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21c1.21.49 2.53.76 3.88.76a1 1 0 011 1v3.5a1 1 0 01-1 1C10.07 22 2 13.93 2 4.5A1 1 0 013 3.5h3.5a1 1 0 011 1c0 1.35.27 2.67.76 3.88a1 1 0 01-.21 1.11l-2.2 2.2z"></path></svg>
            ...
            {resumeData?.contactInfo?.email && (
              <span key="email" style={{ 
                ...
                <svg width="12" height="12" fill="#0056b3" style={{ flexShrink: 0, display: 'block' }} viewBox="0 0 24 24"><path d="M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2zm0 2v.01L12 13 4 6.01V6h16zM4 20V8.24l7.12 6.16a1 1 0 001.36 0L20 8.24V20H4z"></path></svg>
            ...
            {resumeData?.contactInfo?.location && (
              <span key="location" style={{ 
                ...
                <svg width="12" height="12" fill="#0056b3" style={{ flexShrink: 0, display: 'block' }} viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5A2.5 2.5 0 1112 6a2.5 2.5 0 010 5.5z"></path></svg>
          ...
          <div style={{ marginBottom: '10pt' }}>
            ...
            <div style={{ 
              ...
              {Object.entries(resumeData.skills).map(([category, skillsString], categoryIndex) => (
                <div key={categoryIndex} style={{ minWidth: '100pt', marginBottom: '2pt' }}>
                  <span style={{ fontWeight: 700, color: '#0056b3' }}>{category}:</span>
                  <span style={{ marginLeft: '4pt', color: '#222' }}>
                    {typeof skillsString === 'string' ? skillsString.trim().replace(/\s+/g, ' ') : skillsString}
                  </span>
                </div>
              ))}
            </div>
